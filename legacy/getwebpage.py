...
for yr in yrs:
    ...
    for month in months:
        ...
        save_object(BaseballData,'MLBDataAug2015through2016.pkl')

print time.clock() - mstart

with open('MLBData2012throughJul2013.pkl','rb') as input:
    Data1 = pickle.load(input)

print 'Loaded 1'

with open('MLBDataAug2013throughJul2015.pkl','rb') as input:
    Data2 = pickle.load(input)

print 'Loaded 2'

merge1 = mergeGameData(Data1,Data2)

merge2 = mergeGameData(merge1,BaseballData)

save_object(merge2,'MLBData2012through2016.pkl')
